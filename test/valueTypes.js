...
const world = require("../causality.js").getWorld({name: "Value types", useNonObservablesAsValues: true});
...
describe("Value types", function(){
  ...
  it('testing', function () {
    ...
    const foo = observable({value: 1, reference: other, complexValue: {bar: 32, fum: 42}});  
    let repeatCounter = 0;
