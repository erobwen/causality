...
export function instance(causalityInstance) {
  const {c, enterContext, repeatOnChange, leaveContext, contextsScheduledForPossibleDestruction, trace, invalidateOnChange, registerAnyChangeObserver, inCachedCall} = causalityInstance;
