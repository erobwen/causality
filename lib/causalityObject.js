...
export function bindToInstance(instance) {
  ...
  const {c, enterContext, repeatOnChange, leaveContext, contextsScheduledForPossibleDestruction, trace, invalidateOnChange, registerAnyChangeObserver, inCachedCall} = instance;
