  ...
  return {
    ...
    recordDependencyOnProperty: (observer, handler, key) => {    
      ...
      if (typeof(handler._propertyObservers[key]) ===  'undefined') {
        ...
        //console.log("observerSet", key, "set to", typeof handler._propertyObservers[key]);
      }

      //console.log("call recordDependency", typeof key, key, "with", typeof handler._propertyObservers[key] );
